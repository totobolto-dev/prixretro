...
def scrape_ebay_console(search_term, console_slug, max_pages=50):
    ...
    # Save results
    output_file = f"scraped_data_{console_slug}_raw.json"
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print("Usage: python3 scraper_ebay_universal.py <search_term> <console_slug>")
        print("\nExamples:")
        print('  python3 scraper_ebay_universal.py "game boy color" gbc')
        print('  python3 scraper_ebay_universal.py "game boy advance" gba')
        print('  python3 scraper_ebay_universal.py "nintendo ds" nds')
        print('  python3 scraper_ebay_universal.py "psp" psp')
        sys.exit(1)

    search_term = sys.argv[1]
    console_slug = sys.argv[2]

    scrape_ebay_console(search_term, console_slug)
