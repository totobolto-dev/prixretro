...
<div class="container">
    ...
    <article style="max-width: 800px;">
        ...
        <p style="color: var(--text-secondary); margin-bottom: 2rem;">
            Publié le {{ date('j F Y') }} • Lecture 6 min
        </p>
        ...
        <div style="background: var(--bg-card); padding: 1.5rem; border-radius: var(--radius); border: 1px solid var(--border); margin-bottom: 2rem;">
            ...
            <ul style="list-style: none; padding: 0;">
                <li style="padding: 0.5rem 0; border-bottom: 1px solid var(--border);">
                    <strong>Prix moyen</strong>: 120-180€ pour une console en bon état
                </li>
                <li style="padding: 0.5rem 0; border-bottom: 1px solid var(--border);">
                ...
                <li style="padding: 0.5rem 0;">
                    <strong>Attention</strong>: Comptes PSN liés, écrans tactiles rayés
                </li>
            </ul>
        </div>
        ...
        <p style="margin-bottom: 1rem;">
            Le modèle original avec écran OLED offre de meilleures couleurs et contrastes.
        ...
        <p style="margin-bottom: 1.5rem;">
            ...
            L'écran LCD est moins impressionnant que l'OLED mais reste très correct.
        ...
        <h3 style="margin-top: 1.5rem; margin-bottom: 0.75rem; color: var(--warning);">⚠️ Compte PSN lié</h3>
        <p style="margin-bottom: 1rem;">
            Demandez au vendeur de retirer son compte PSN avant l'envoi. Une Vita liée à un compte
        ...
        <p style="margin-bottom: 1rem;">
            La PS Vita est une excellente console portable avec un catalogue de qualité (RPG japonais,
            visual novels, indie games). Cependant, le prix des cartes mémoires propriétaires reste un frein.
        </p>

        <p style="margin-bottom: 2rem;">
            <strong>Budget recommandé</strong> : 180-220€ tout compris (console Slim + carte mémoire 16 GB + 2-3 jeux).
            C'est plus cher qu'une 3DS mais l'expérience vaut le coup pour les fans de RPG.
        </p>
